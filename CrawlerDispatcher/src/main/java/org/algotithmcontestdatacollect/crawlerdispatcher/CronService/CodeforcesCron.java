...
public class CodeforcesCron {
    ...
    public void getStuContest() {
        ...
        try {
            ...
            try {
                ...
                List<CfAccountWithUsername> entities = userAccountService.getCfAccounts(); // 获取所有的Cf实体
    ...
    public void getStuRecord() {
        ...
        try {
            ...
            List<String> cfids = new ArrayList<>();
            try {
                List<CfAccountWithUsername> entities = userAccountService.getCfAccounts();
    ...
    public void getSubmitCode() {
        ...
        for (var entity : entities) {
            ...
            Optional<CfAccount> byId = cfAccountRepository.findById(entity.getCfid());
            if (byId.isPresent()) {
                ...
                try {
                    ...
                    param.add(cid);
                    param.add(byId.get().getCodeforcesId());
