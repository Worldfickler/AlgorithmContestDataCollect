...
import org.algotithmcontestdatacollect.crawlerdispatcher.TableEntity.AcStucontest;
...
public interface AcStucontestRepository extends JpaRepository<AcStucontest,Long> {
    ...
    public List<AcStucontest> getRecentContestsByAcid(@Param("acid") Long acid, @Param("limit") Integer limit);
    ...
    public List<AcStucontest> getRecentContestsByAcidAndCid(@Param("acid") Long acid, @Param("cids") List<Long> cids);
    ...
    List<AcStucontest> getNoSubmitStuContest();
}
