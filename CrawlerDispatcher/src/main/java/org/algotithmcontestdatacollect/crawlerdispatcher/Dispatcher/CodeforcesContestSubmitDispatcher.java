...
public class CodeforcesContestSubmitDispatcher extends AbstractDispatcher {
    @Autowired
    private Environment environment;
    @Override
    protected String getSpider() {
        return "CodeforcesContestSubmitSpider";// Endpoint的Spider名称,会根据该名称调用Spider
    }

    @Override
    protected String getHandler() {
        return "SingleCodeforcesContestSubmitHandler"; // Endpoint的Handler名称,会根据该名称调用Handler
    }
