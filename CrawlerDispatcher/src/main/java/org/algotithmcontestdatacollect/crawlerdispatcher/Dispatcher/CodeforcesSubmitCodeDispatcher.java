...
public class CodeforcesSubmitCodeDispatcher extends AbstractDispatcher {
    @Autowired
    private Environment environment;

    @Override
    protected String getSpider() {
        return "CodeforcesSubmitCodeAPISpider";// Endpoint的Spider名称,会根据该名称调用Spider
    }

    @Override
    protected String getHandler() {
        return "SingleCodeforcesSubmitCodeAPIHandler"; // Endpoint的Handler名称,会根据该名称调用Handler
    }
