...
public class AtcoderDataController {
    ...
    public String getAllContest(){
        List<AcContestWithParticipate> l;
        try{
    ...
    public String getContestParticipate(@PathVariable Long cid) {
        List<AcStucontestWithUserinfo> l;
        try{
            l = acStucontestWithUserinfoRepository.getAcStucontestWithUserinfoEntitiesByCid(cid);
            Collections.sort(l, Comparator.comparingInt(AcStucontestWithUserinfo::gettRank));
        }catch (Exception E){
            return ResponseUtil.JSONReturn(404,"数据库异常");
        }
        return ResponseUtil.JSONReturn(200,(JSONArray) JSONArray.toJSON(l));
    ...
    public String getUserParticipate(@PathVariable String atcoder_id) {
        try{
            List<AcStucontestWithCinfoUserinfo> acStucontestWithUserinfoEntities = acStucontestWithCinfoUserinfoRepository.getAcStucontestWithCinfoUserinfoEntitiesByAtcoderId(atcoder_id);
    ...
    public String getUserAfterSubmit(@PathVariable String atcoder_id) {
        try{
            List<AcSubmitWithUserinfo> acSubmitWithUserinfoEntities = acSubmitWithUserinfoRepository.getAcSubmitWithUserinfoEntitiesByAtcoderIdAndIsAfter(atcoder_id,(byte) 1);
    ...
    public String getUserContestSubmit(@PathVariable String atcoder_id) {
        try{
            List<AcSubmitWithUserinfo> acSubmitWithUserinfoEntities = acSubmitWithUserinfoRepository.getAcSubmitWithUserinfoEntitiesByAtcoderIdAndIsAfter(atcoder_id,(byte) 0);
            if (acSubmitWithUserinfoEntities.size() != 0) {
                return ResponseUtil.JSONReturn(200, (JSONArray) JSONArray.toJSON(acSubmitWithUserinfoEntities));
            }
        }catch (Exception E) {
    ...
    public String getAccountParticipate(@PathVariable String username) {
        try{
            List<AcStucontestWithCinfoUserinfo> acStucontestWithUserinfoEntities = acStucontestWithCinfoUserinfoRepository.getAcStucontestWithCinfoUserinfoEntitiesByUsername(username);
            var retData = (JSONArray) JSONArray.toJSON(acStucontestWithUserinfoEntities);
            if (acStucontestWithUserinfoEntities.size() != 0) {
                return ResponseUtil.JSONReturn(200, retData);
            }
    ...
    public String getAccountAfterSubmit(@PathVariable String username) {
        try{
            List<AcSubmitWithUserinfo> acSubmitWithUserinfoEntities = acSubmitWithUserinfoRepository.getAcSubmitWithUserinfoEntitiesByUsernameAndIsAfter(username,(byte) 1);
            if (acSubmitWithUserinfoEntities.size() != 0) {
                return ResponseUtil.JSONReturn(200, (JSONArray) JSONArray.toJSON(acSubmitWithUserinfoEntities));
            }
        }catch (Exception E) {
    ...
    public String getAccountContestSubmit(@PathVariable String username) {
        try{
            List<AcSubmitWithUserinfo> acSubmitWithUserinfoEntities = acSubmitWithUserinfoRepository.getAcSubmitWithUserinfoEntitiesByUsernameAndIsAfter(username,(byte) 0);
            if (acSubmitWithUserinfoEntities.size() != 0) {
                return ResponseUtil.JSONReturn(200, (JSONArray) JSONArray.toJSON(acSubmitWithUserinfoEntities));
            }
        }catch (Exception E) {
