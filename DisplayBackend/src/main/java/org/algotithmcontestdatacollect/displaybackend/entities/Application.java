...
public class Application {
    ...
    static public Application createNewUser(String username, String password, Long school, String classname, Integer year, String stuno, String realname) {
    ...
    static public Application addCodeforcesAccount(String codeforcesAccount, Long uid, Byte is_main, Long school) {
        Application entity = new Application();
        var parameter = new JSONObject();
        entity.uid = uid;
    ...
    static public Application addAtcoderAccount(String atcoderAccount, Long uid, Byte is_main, Long school) {
        Application entity = new Application();
        var parameter = new JSONObject();
        entity.uid = uid;
    ...
    static public Application ParseRequest(String Operation, Long uid, Long school, JSONObject params){
        Application entity = new Application();
        entity.uid = uid;
        entity.opertation = Operation;
        entity.parameter = params.toJSONString();
        entity.school = school;
        entity.time = System.currentTimeMillis();
        entity.status = 0;
        entity.adminName = null;
