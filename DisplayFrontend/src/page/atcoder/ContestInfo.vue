<template>
  ...
  <el-tabs>
    ...
    <el-tab-pane label="解题情况" lazy>
      <QuestionPie :root-data="submitList" type="ac" :contest-data="contestInfo"></QuestionPie>
      <div class="split"></div>
      <QuestionSolveTimeBar :root-data="submitList" type="ac" :contest-data="contestInfo"></QuestionSolveTimeBar>
    </el-tab-pane>
    <el-tab-pane label="比赛提交动态图" lazy>
      <solve-with-time :root-data="submitList" type="ac" :contest-data="contestInfo"></solve-with-time>
    </el-tab-pane>
