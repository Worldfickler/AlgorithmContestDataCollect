...
let intelligentAPI = {
    ...
    addQuestionClickTime(cid, qIndex, generateName) {
        return Axios.post(`/user/intelligentTrain/addQuestionClickTime/${cid}/${qIndex}/${generateName}`)
    }
}
let requestUtil = {
    ...
    updateMyInfo(classname, year, stuno, realname, employInfo) {
        return Axios.post("/user/modifyInfo", {classname, year, stuno, realname, employInfo})
    },
    getAllUser() {
    ...
    getPrizeByUids(params) {
        return Axios.post("/prize/getByUids", params)
    },
    getUserPrize() {
        return Axios.post("/user/prize/getUserPrize")
    },
    updateUserPrize(params) {
        return Axios.post("/user/prize/update", params)
    },
    savePrize(params) {
        return Axios.post("/user/prize/save", params)
    },
    codeforcesAPI,
    atcoderAPI,
    intelligentAPI
