...
public class CodeforcesProblems {
    ...
    private String name;
    public CodeforcesProblems() {
    }

    public CodeforcesProblems(Long cid, String qindex, Integer difficulty, String name) {
        this.cid = cid;
        this.qindex = qindex;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CodeforcesProblems)) return false;
        CodeforcesProblems that = (CodeforcesProblems) o;
