...
@IdClass(CodeforcesProblemsTagMapPK.class)
public class CodeforcesProblemsTagMap {
    ...
    public boolean equals(Object o) {
        ...
        CodeforcesProblemsTagMap that = (CodeforcesProblemsTagMap) o;
    ...
    public CodeforcesProblemsTagMap() {
    }

    public CodeforcesProblemsTagMap(Integer codeforcesProblemId, Integer tagId) {
        this.codeforcesProblemId = codeforcesProblemId;
        this.tagId = tagId;
    }
