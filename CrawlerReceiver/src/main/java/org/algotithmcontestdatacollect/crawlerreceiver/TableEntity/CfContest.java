...
public class CfContest {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CfContest)) return false;
        CfContest that = (CfContest) o;
        return level == that.level && startTimeStamp == that.startTimeStamp && endTimeStamp == that.endTimeStamp && duration == that.duration && Objects.equals(cid, that.cid) && Objects.equals(name, that.name) && Objects.equals(type, that.type) && Objects.equals(isNormal, that.isNormal);
    }
    ...
    public static CfContest CreateCfContestEntityFromCFContestList(JSONObject obejct) {
        ...
        return new CfContest(cid,name,type,level,start, start + duration,duration, (short) 1);
    }

    public CfContest(Long cid, String name, String type, int level, Long startTimeStamp, Long endTimeStamp, Long duration, Short isNormal) {
        this.cid = cid;
        this.name = name;
        this.type = type;
        this.level = level;
