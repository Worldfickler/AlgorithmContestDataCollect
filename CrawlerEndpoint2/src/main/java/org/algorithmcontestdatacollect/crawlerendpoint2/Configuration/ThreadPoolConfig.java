...
public class ThreadPoolConfig {
    ...
    public TaskExecutor taskExecutor() {
        ...
        executor.setCorePoolSize(Runtime.getRuntime().availableProcessors()/5); // 核心线程数设置为机器的核心数
        executor.setMaxPoolSize(Runtime.getRuntime().availableProcessors()/2); // 最大线程数设置为核心数的两倍
