...
@Entity
@Table(name = "ac_account_total_info", schema = "graduate")
public class AcAccountTotalInfo {
    @Basic
    ...
    public boolean equals(Object o) {
        ...
        AcAccountTotalInfo that = (AcAccountTotalInfo) o;
        return rating == that.rating && isMain == that.isMain && isUsing == that.isUsing && participateTime == that.participateTime && Objects.equals(username, that.username) && Objects.equals(realname, that.realname) && Objects.equals(classname, that.classname) && Objects.equals(school, that.school) && Objects.equals(status, that.status) && Objects.equals(stuNo, that.stuNo) && Objects.equals(year, that.year) && Objects.equals(id, that.id) && Objects.equals(uid, that.uid) && Objects.equals(atcoderId, that.atcoderId) && Objects.equals(solve, that.solve) && Objects.equals(after, that.after);
    }

    @Override
    public int hashCode() {
        return Objects.hash(username, realname, classname, school, status, stuNo, year, id, uid, atcoderId, rating, isMain, isUsing, participateTime, solve, after);
    }
}
