...
public class CfStucontestWithCinfoUserinfo {
    @Id
    @Basic
    ...
    public boolean equals(Object o) {
        ...
        CfStucontestWithCinfoUserinfo that = (CfStucontestWithCinfoUserinfo) o;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, cid, cfid, tRank, solve, diff, rating, codeforcesId, username, classname, stuNo, school, realname, name, startTimeStamp);
    }
}
