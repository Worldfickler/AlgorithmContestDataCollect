...
public class CfAccountWithUsername {
    ...
    public boolean equals(Object o) {
        ...
        return isMain == that.isMain && isUsing == that.isUsing && Objects.equals(username, that.username) && Objects.equals(id, that.id) && Objects.equals(uid, that.uid) && Objects.equals(codeforcesId, that.codeforcesId) && Objects.equals(rating, that.rating);
    }

    @Override
    public int hashCode() {
        return Objects.hash(username, id, uid, codeforcesId, rating, isMain, isUsing);
    }
