...
@Service
public class GetAtcoderAfterSolveHandler extends AbstarctHandler{
    @Autowired
    ...
    public void Handle(Application entity) throws Exception {
        ...
        mp.put("spider","AtcoderContestSubmitSpider");
        mp.put("handler","SingleAtcoderContestSubmitHandler");
        var params = new JSONArray();
        var paramObj = JSONObject.parseObject(entity.getParameter());
        params.add(paramObj.getString("atcoderId"));
        params.add(paramObj.getString("nickName"));
